    ...
    return (
        <div>
            <div className='mt-16 text-center'>
                <h1 className='text-4xl font-bold text-blue-900 '>Vocab</h1>
            ...
            <footer className=" text-center pb-6">
                <div>
                    <h3><span className='font-semibold'>Contact us:</span> vocab@school.net</h3></div>
                <div>
                ...
                <div className='text-sm'>&copy; 2024 Vocab. All rights reserved.</div>
            </footer>
        </div>
    );
};
